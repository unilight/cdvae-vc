...
class CDVAEGANTrainer(Trainer):
    ...
    def _optimize(self):
        ...
        d_vars = [v for v in var_list if 'SP_Discriminator' in v.name]
        ...
        obj_sp_Gx = -r * self.loss['wgan_sp'] - self.loss['recon_sp'] - self.loss['cross_mcc2sp']
        obj_mcc_Gx = - self.loss['recon_mcc'] - self.loss['cross_sp2mcc']
        obj_D = self.loss['wgan_sp'] + gp_weight * self.loss['wgan_gp_sp']
